...
const Hero = () => {
  return (
    <div className='min-h-[110vh] flex items-center justify-center overflow-hidden' id='hero'>
      <motion.section className='text-center max-w-[1440px] mt-32'>
        ...
        <div className='social-icons gap-2 lg:gap-5 justify-center'>
          <a href='https://www.facebook.com/shempot1601 ' target='_blank'>
            <BsFacebook
              size={30}
              className='text-blue-600   hover:text-sky-500 duration-500 cursor-pointer'
            />
          </a>
          <a href='https://www.linkedin.com/in/markjosephestacio/' target='_blank'>
            <BsLinkedin
              size={30}
