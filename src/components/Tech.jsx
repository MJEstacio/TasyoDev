...
import { SiCss3, SiJavascript, SiTailwindcss, SiReact, SiNextdotjs, SiPhp, SiMysql, SiTypescript, SiSvelte } from 'react-icons/si';
...
const Tech = () => {
  ...
  return (
    <div ref={myRef} className='tech py-10' id='tech'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 px-2 py-10 max-w-[1440px] mx-auto gap-5'>
        ...
        <div className='flex flex-col items-center p-5 border border-2 rounded-md text-gray-800 dark:bg-white'>
          <SiPhp size={30} className='text-blue-600' />
          <span>PHP</span>
        </div>
        <div className='flex flex-col items-center p-5 border border-2 rounded-md text-gray-800 dark:bg-white'>
          <SiMysql size={30} className='text-blue-600' />
          <span>MySQL</span>
        </div>
        <div className='flex flex-col items-center p-5 border border-2 rounded-md text-gray-800 dark:bg-white'>
